class ScoringButtonEntity extends Phaser.Group{
    action:Function;
    
    constructor(game:Phaser.Game, x:number, y:number, type:number, action:Function){
        super(game);
        ...
        let image:Phaser.Image = new Phaser.Image(game, 0, 0, type==0?GameTextures.gameCenter:GameTextures.googlePlay);
